...
// --- LÓGICA DO DIALOG (AULA 10 - Versão Moderna) ---

// Selecionando os elementos do diálogo
...
// Fecha o diálogo ao clicar fora dele (no backdrop)
if (dialog) {
    dialog.addEventListener('click', (event) => {
        // Verifica se o clique foi no próprio elemento dialog (que funciona como o container)
        // e não em um de seus filhos.
...
// --- LÓGICA DO CARROSSEL (AULA 11) ---
// Carrossel de imagens
// Seleciona o container que desliza os slides
console.log('---Aula 11: Carrossel Dinâmico e "Manual"');
